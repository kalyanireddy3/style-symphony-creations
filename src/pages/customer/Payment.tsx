...
const Payment = () => {
  ...
  const handleMakePayment = async () => {
    ...
    try {
      ...
      await mockMakePayment(request.id, timelineUpdate.id, timelineUpdate.paymentAmount);
  ...
  const getStatusLabel = (status: string) => {
    switch(status) {
      ...
      case 'stitched': return 'Stitching Complete';
      case 'dyed': return 'Dyeing Complete';
      case 'fitting': return 'Fitting Complete';
