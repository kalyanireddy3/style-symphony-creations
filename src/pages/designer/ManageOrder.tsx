...
import { ProjectRequest, User, TimelineUpdate } from '@/types';
...
const ManageOrder = () => {
  ...
  const handleAddTimelineUpdate = async (
    ...
    try {
      const newUpdate = await mockAddTimelineUpdate(request.id, status, message, paymentRequired, paymentAmount);
        ...
        <div className="flex flex-col md:flex-row justify-between mb-6">
          <div>
            ...
            <div className="flex items-center mt-2">
              <Badge className={request.status === 'completed' ? 'bg-purple-100 text-purple-800 border-purple-200' : 'bg-blue-100 text-blue-800 border-blue-200'}>
